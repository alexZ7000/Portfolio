    ...
    useEffect(() => {
        ...
        tl.fromTo(
            ...
            { opacity: 0, scale: 0.9 },
            {
                ...
                scale: 1,
                fill: "none",
                stroke: "filter: drop-shadow(0 0 10px rgba(57, 255, 20, 0.9))",
                rotate: 0,
                duration: 1.5,
                ease: "power4.out"
            }
            ...
            .to("#dragon-path", {
                filter: "drop-shadow(0px 0px 20px rgba(57, 255, 20, 0.8))",
                scale: 1.05,
                duration: 2,
                ease: "power4.out"
            })
    ...
    return (
        ...
        >
            <g
                ...
                stroke={`${isDarkTheme ? "#39ff14" : "#155a08"}`}
            >
                <path
                    d="M5649 9252 c-14 -9 -54 -40 -90 -68 -164 -131 -463 -317 -655 -410
...
17 62 29 64 28 2 -1 -19 -27 -47 -58z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M4675 9021 c-148 -144 -241 -218 -455 -361 -115 -76 -403 -288 -476
...
-75 -63 -154 -139z"
                ...
                />
                <path
                    d="M3750 8776 c-264 -68 -305 -81 -423 -127 -312 -124 -577 -311 -661
...
208 577 285 219 88 384 173 328 169 -7 0 -105 -25 -218 -53z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M5580 8720 c-176 -10 -243 -28 -490 -132 -209 -88 -353 -171 -431
...
37 -760 25z"
                ...
                />
                <path
                    d="M2180 8624 c-345 -116 -652 -411 -738 -709 -28 -99 -34 -138 -33
...
23 83 48 95 57 l21 15 -24 0 c-14 0 -72 -16 -130 -36z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M6500 8135 c0 -12 110 -58 265 -110 306 -103 672 -254 990 -410 103
...
-136 34 -387 67 -387 50z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M5546 7390 c-8 -60 -47 -166 -88 -240 -37 -66 -74 -114 -194 -245
...
-4z m-96 -9 c-3 -3 -12 -4 -19 -1 -8 3 -5 6 6 6 11 1 17 -2 13 -5z"
                ...
                />
                <path
                    d="M5400 7385 c-14 -8 -61 -26 -106 -40 -78 -24 -130 -60 -155 -107 -8
-15 -6 -18 15 -18 37 0 140 35 191 64 24 15 56 43 70 64 37 54 33 64 -15 37z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M5235 7080 c-16 -5 -85 -16 -152 -24 -136 -18 -173 -29 -173 -50 0
-31 42 -46 125 -46 97 0 142 19 205 84 46 48 45 50 -5 36z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M4500 6809 c-75 -33 -144 -81 -128 -89 35 -20 171 -41 255 -41 120 0
251 31 305 70 47 35 45 36 -92 46 -52 4 -129 13 -170 21 -95 18 -115 17 -170
-7z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M1542 6615 c-109 -30 -197 -102 -240 -195 -37 -78 -43 -211 -14 -307
...
181 23 46 26 63 21 110 -15 147 -135 293 -282 344 -78 27 -234 34 -303 15z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M4040 6502 c-25 -16 -67 -53 -95 -82 l-50 -52 190 5 c105 4 217 12
251 20 61 13 196 85 187 99 -2 5 -64 8 -136 8 -119 0 -177 5 -272 25 -23 5
-40 -1 -75 -23z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M3765 6190 c-77 -91 -140 -206 -165 -305 -11 -43 -18 -80 -16 -82 2
...
-33 13 37 c20 58 74 160 95 181 13 13 15 20 7 20 -7 0 -39 -32 -72 -70z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M3893 5661 c-122 -64 -186 -106 -276 -184 l-57 -49 5 43 c5 33 3 41
-6 32 -20 -20 -11 -313 10 -313 3 0 28 32 56 71 54 77 150 172 263 259 53 41
78 68 96 105 30 63 40 95 29 95 -4 0 -59 -27 -120 -59z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M7143 5610 c-33 -13 -52 -49 -59 -112 l-7 -56 49 -6 c27 -4 82 -13
123 -21 41 -8 76 -13 79 -10 2 2 -5 35 -17 74 -35 115 -94 161 -168 131z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M6776 5460 c-51 -16 -111 -85 -86 -100 6 -4 66 7 133 25 67 18 136
35 152 40 l30 7 -40 15 c-51 18 -152 25 -189 13z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M3955 5213 c-71 -66 -255 -216 -259 -212 -2 2 -8 13 -15 24 -10 17
-11 15 -6 -15 19 -109 68 -200 106 -200 5 0 22 19 39 43 219 304 213 292 204
356 -4 28 -9 51 -13 51 -3 -1 -28 -22 -56 -47z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M3025 4999 c-251 -44 -421 -113 -723 -293 -452 -270 -742 -575 -950
...
148 44 148 86 0 43 -15 65 -51 78 -50 17 -260 12 -384 -10z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M6026 4861 c-105 -99 -262 -198 -429 -271 -78 -34 -194 -86 -257
...
-75 -71z"
                ...
                />
                <path
                    d="M4180 4885 c-7 -9 -60 -49 -118 -90 -72 -52 -113 -75 -133 -75 -16 0
-29 -4 -29 -8 0 -19 96 -103 129 -112 64 -18 67 -15 137 93 75 115 89 146 80
182 -7 29 -46 35 -66 10z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M3470 4711 c-293 -105 -429 -168 -625 -286 -71 -43 -182 -100 -245
...
37 -345 119 -486 212 -85 56 -219 181 -229 215 -9 27 -34 24 -155 -20z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M4433 4662 c-29 -27 -85 -64 -125 -85 l-72 -36 46 -21 c37 -16 84
...
-21 86 16 59 16 62 -2 75 -32 23 -58 15 -112 -34z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                ...
                />
                <path
                    d="M8205 3570 c-22 -21 -82 -72 -134 -112 -52 -40 -99 -80 -104 -89 -8
...
341 36 190 2 443 -90 661 -48 115 -255 421 -284 421 -4 0 -25 -18 -47 -40z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M2075 3568 c-43 -37 -151 -197 -184 -273 -40 -90 -51 -161 -50 -320
1 -95 4 -139 9 -120 46 170 113 350 160 430 84 142 136 283 113 306 -7 7 -22
1 -48 -23z"
                    strokeWidth={`${strokeWidth}`}
                />
                <path
                    d="M1956 2885 c3 -38 10 -88 15 -109 6 -21 21 -91 34 -154 53 -254 247
